...
DROP TABLE `books`;
CREATE TABLE `books` ( `u_id` varchar(25) NOT NULL, `r_id` int(11) NOT NULL, `qnty` int(11) NOT NULL, `start_time` time NOT NULL, `end_time` time NOT NULL, `date` date NOT NULL, PRIMARY KEY(`u_id`,`r_id`,`date`), FOREIGN KEY (`u_id`) REFERENCES user(`id`), FOREIGN KEY (`r_id`) REFERENCES restaurant(`id`) )
